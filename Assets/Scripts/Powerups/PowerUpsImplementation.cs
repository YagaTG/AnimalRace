...
public class PowerUpsImplementation : MonoBehaviour
{
    ...
    public void minigameSelect(Player player)
    {
        ...
        SelectMiniGameScript.text = player.getName() + " пожалуйста, выберите мини-игру, чтобы продолжить игру:"; 
