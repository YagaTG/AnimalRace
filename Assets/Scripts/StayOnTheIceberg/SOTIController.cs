...
public class SOTIController : MonoBehaviour
{
    ...
    public void PlayerDies(string name)
    {
        ...
        if (name == "Player1")
        {
            gameOverText.SetText(MinigameLoadPlayers.GetListOfPlayersPlaying()[0].getName() + " умер, " + MinigameLoadPlayers.GetListOfPlayersPlaying()[1].getName() + " победил!");
            winIndex = 1;
            loseIndex = 0;
        }
        else if (name == "Player2")
        {
            gameOverText.SetText(MinigameLoadPlayers.GetListOfPlayersPlaying()[1].getName() + " умер, " + MinigameLoadPlayers.GetListOfPlayersPlaying()[0].getName() + " победил!");
            winIndex = 0;
            loseIndex = 1;
        }
