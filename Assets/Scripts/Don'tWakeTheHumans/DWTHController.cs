...
public class DWTHController : MonoBehaviour
{
    ...
    void Update()
    {
        if (!gameOver) // While the game isn't finished
        {
            ...
            player1Score.text = "Игрок 1 Очки: " + player1.numPushed;
            player2Score.text = "Игрок 2 Очки: " + player2.numPushed;
    ...
    private void gameOverEvent()
    {
        ...
        gameOverText.text = (winner == -1 ? "Нет победителя!" : playersPlaying[winner].getName() + " победил!");
